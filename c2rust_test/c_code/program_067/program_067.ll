...
9:                                                ; preds = %1
  ...
  call void @enQueue(ptr noundef %10, ptr noundef %11)
  br label %12

12:                                               ; preds = %43, %9
  %13 = load ptr, ptr %4, align 8
  %14 = call i32 @isEmpty(ptr noundef %13)
  %15 = icmp ne i32 %14, 0
  %16 = xor i1 %15, true
...
17:                                               ; preds = %12
  ...
  %19 = call ptr @deQueue(ptr noundef %18)
  store ptr %19, ptr %3, align 8
  %20 = load ptr, ptr %3, align 8
  %21 = getelementptr inbounds nuw %struct.BinaryTreeNode, ptr %20, i32 0, i32 0
  %22 = load i32, ptr %21, align 8
  %23 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, i32 noundef %22)
  %24 = load ptr, ptr %3, align 8
  %25 = getelementptr inbounds nuw %struct.BinaryTreeNode, ptr %24, i32 0, i32 1
  %26 = load ptr, ptr %25, align 8
...
28:                                               ; preds = %17
  ...
  %31 = getelementptr inbounds nuw %struct.BinaryTreeNode, ptr %30, i32 0, i32 1
  %32 = load ptr, ptr %31, align 8
  call void @enQueue(ptr noundef %29, ptr noundef %32)
  br label %33

33:                                               ; preds = %28, %17
  %34 = load ptr, ptr %3, align 8
  %35 = getelementptr inbounds nuw %struct.BinaryTreeNode, ptr %34, i32 0, i32 2
  %36 = load ptr, ptr %35, align 8
...
38:                                               ; preds = %33
  ...
  %41 = getelementptr inbounds nuw %struct.BinaryTreeNode, ptr %40, i32 0, i32 2
  %42 = load ptr, ptr %41, align 8
  call void @enQueue(ptr noundef %39, ptr noundef %42)
  br label %43
...
44:                                               ; preds = %12
  ...
  call void @deleteQueue(ptr noundef %45)
  br label %46
...
define dso_local i32 @main() #0 {
  ...
  store ptr %7, ptr %9, align 8
  %10 = call ptr @createNewNode(i32 noundef 9)
  %11 = load ptr, ptr %2, align 8
  ...
  call void @levelOrder(ptr noundef %47)
  ret i32 0
}
