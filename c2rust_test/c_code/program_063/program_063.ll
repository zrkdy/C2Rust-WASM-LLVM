; ModuleID = './c_code/temp_compile/getMinimum.c'
source_filename = "./c_code/temp_compile/getMinimum.c"
...
@.str.6 = private unnamed_addr constant [19 x i8] c"Stack is not empty\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @deleteStackA(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = icmp ne ptr %3, null
...
5:                                                ; preds = %1
  %6 = load ptr, ptr %2, align 8
  %7 = getelementptr inbounds nuw %struct.AdvancedStack, ptr %6, i32 0, i32 0
  %8 = load ptr, ptr %7, align 8
  call void @deleteStackA(ptr noundef %8)
  %9 = load ptr, ptr %2, align 8
  %10 = getelementptr inbounds nuw %struct.AdvancedStack, ptr %9, i32 0, i32 1
  %11 = load ptr, ptr %10, align 8
  call void @deleteStackA(ptr noundef %11)
...
12:                                               ; preds = %7
  ...
  call void @pushA(ptr noundef %13, i32 noundef %14)
  br label %15
...
18:                                               ; preds = %7
  ...
  %20 = call i32 @peekA(ptr noundef %19)
  %21 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %20)
  %22 = load ptr, ptr %4, align 8
  %23 = call i32 @sizeA(ptr noundef %22)
...
29:                                               ; preds = %25
  ...
  %31 = call i32 @popA(ptr noundef %30)
...
36:                                               ; preds = %25
  ...
  %38 = call i32 @isEmptyA(ptr noundef %37)
  %39 = icmp ne i32 %38, 0
...
44:                                               ; preds = %42, %40
  ...
  call void @deleteStackA(ptr noundef %45)
  ret i32 0
}
