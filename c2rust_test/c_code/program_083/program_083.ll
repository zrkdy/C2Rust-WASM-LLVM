...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @findMaxUsingLevelOrder(%struct.BinaryTreeNode* %0) #0 {
  %2 = alloca %struct.BinaryTreeNode*, align 8
  %3 = alloca %struct.BinaryTreeNode*, align 8
  ...
  %6 = call %struct.Queue* @createQueue()
  store %struct.Queue* %6, %struct.Queue** %5, align 8
  %7 = load %struct.Queue*, %struct.Queue** %5, align 8
  %8 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %2, align 8
  call void @enQueue(%struct.Queue* %7, %struct.BinaryTreeNode* %8)
  br label %9

9:                                                ; preds = %46, %1
  %10 = load %struct.Queue*, %struct.Queue** %5, align 8
  %11 = call i32 @isEmpty(%struct.Queue* %10)
  %12 = icmp ne i32 %11, 0
  %13 = xor i1 %12, true
...
14:                                               ; preds = %9
  ...
  %16 = call %struct.BinaryTreeNode* @deQueue(%struct.Queue* %15)
  store %struct.BinaryTreeNode* %16, %struct.BinaryTreeNode** %3, align 8
  %17 = load i32, i32* %4, align 4
  %18 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %3, align 8
  %19 = getelementptr inbounds %struct.BinaryTreeNode, %struct.BinaryTreeNode* %18, i32 0, i32 0
  %20 = load i32, i32* %19, align 8
  %21 = icmp slt i32 %17, %20
  br i1 %21, label %22, label %26

22:                                               ; preds = %14
  %23 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %3, align 8
  %24 = getelementptr inbounds %struct.BinaryTreeNode, %struct.BinaryTreeNode* %23, i32 0, i32 0
  %25 = load i32, i32* %24, align 8
  store i32 %25, i32* %4, align 4
  br label %26

26:                                               ; preds = %22, %14
  %27 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %3, align 8
  %28 = getelementptr inbounds %struct.BinaryTreeNode, %struct.BinaryTreeNode* %27, i32 0, i32 1
  %29 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %28, align 8
  %30 = icmp ne %struct.BinaryTreeNode* %29, null
  br i1 %30, label %31, label %36

31:                                               ; preds = %26
  %32 = load %struct.Queue*, %struct.Queue** %5, align 8
  %33 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %3, align 8
  ...
  call void @enQueue(%struct.Queue* %32, %struct.BinaryTreeNode* %35)
  br label %36

36:                                               ; preds = %31, %26
  %37 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %3, align 8
  %38 = getelementptr inbounds %struct.BinaryTreeNode, %struct.BinaryTreeNode* %37, i32 0, i32 2
  %39 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %38, align 8
  %40 = icmp ne %struct.BinaryTreeNode* %39, null
  br i1 %40, label %41, label %46

41:                                               ; preds = %36
  %42 = load %struct.Queue*, %struct.Queue** %5, align 8
  %43 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %3, align 8
  %44 = getelementptr inbounds %struct.BinaryTreeNode, %struct.BinaryTreeNode* %43, i32 0, i32 2
  %45 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %44, align 8
  call void @enQueue(%struct.Queue* %42, %struct.BinaryTreeNode* %45)
  br label %46
...
47:                                               ; preds = %9
  ...
  call void @deleteQueue(%struct.Queue* %48)
...
define dso_local i32 @main() #0 {
  ...
  %10 = call %struct.BinaryTreeNode* @createNewNode(i32 19)
  ...
  %46 = load %struct.BinaryTreeNode*, %struct.BinaryTreeNode** %2, align 8
  %47 = call i32 @findMaxUsingLevelOrder(%struct.BinaryTreeNode* %46)
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.5, i64 0, i64 0), i32 %47)
  ret i32 0
}
