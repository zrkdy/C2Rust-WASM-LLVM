...
define dso_local i32 @main() #0 {
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 %16, i32 %17, i32 %18)
  %20 = load i32, i32* %2, align 4
  call void @insert_at_tail(i32 %20)
  %21 = load i32, i32* %3, align 4
  call void @insert_at_tail(i32 %21)
  %22 = load i32, i32* %4, align 4
  call void @insert_at_tail(i32 %22)
  call void @printLinkedListForward()
  %23 = load i32, i32* %13, align 4
  %24 = load i32, i32* %12, align 4
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i64 0, i64 0), i32 %23, i32 %24)
  %26 = load i32, i32* %13, align 4
  %27 = load i32, i32* %12, align 4
  call void @insert_at_middle(i32 %26, i32 %27)
  call void @printLinkedListForward()
  %28 = load i32, i32* %14, align 4
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i32 %28)
  %30 = load i32, i32* %14, align 4
  call void @deleteNode(i32 %30)
  call void @printLinkedListForward()
  %31 = load i32, i32* %5, align 4
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i64 0, i64 0), i32 %31)
  %33 = load i32, i32* %5, align 4
  call void @insert_at_head(i32 %33)
  call void @printLinkedListForward()
  %34 = load i32, i32* %6, align 4
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4, i64 0, i64 0), i32 %34)
  %36 = load i32, i32* %6, align 4
  call void @insert_at_tail(i32 %36)
  call void @printLinkedListForward()
  %37 = load i32, i32* %7, align 4
  %38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i64 0, i64 0), i32 %37)
  %39 = load i32, i32* %7, align 4
  call void @insert_at_head(i32 %39)
  call void @printLinkedListForward()
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.5, i64 0, i64 0))
  call void @deleteNode(i32 1)
  call void @printLinkedListForward()
  %41 = load i32, i32* %8, align 4
  %42 = load i32, i32* %9, align 4
  %43 = load i32, i32* %10, align 4
  %44 = load i32, i32* %11, align 4
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.6, i64 0, i64 0), i32 %41, i32 %42, i32 %43, i32 %44)
  %46 = load i32, i32* %8, align 4
  call void @insert_at_tail(i32 %46)
  %47 = load i32, i32* %9, align 4
  call void @insert_at_tail(i32 %47)
  %48 = load i32, i32* %10, align 4
  call void @insert_at_tail(i32 %48)
  %49 = load i32, i32* %11, align 4
  call void @insert_at_tail(i32 %49)
  call void @printLinkedListForward()
  call void @printLinkedListBackward()
  %50 = load i32, i32* %9, align 4
  store i32 %50, i32* %15, align 4
  %51 = load i32, i32* %15, align 4
  %52 = call zeroext i1 @isValueAvailable(i32 %51)
...
58:                                               ; preds = %0
  ...
  %60 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8, i64 0, i64 0), i32 %59)
  br label %61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @deleteNode(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca %struct.linked_list*, align 8
...
12:                                               ; preds = %9
  ...
  %14 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %13, i32 0, i32 1
  %15 = load %struct.linked_list*, %struct.linked_list** %14, align 8
  store %struct.linked_list* %15, %struct.linked_list** @head, align 8
  %16 = load %struct.linked_list*, %struct.linked_list** @head, align 8
  %17 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %16, i32 0, i32 1
  %18 = load %struct.linked_list*, %struct.linked_list** %17, align 8
  %19 = icmp eq %struct.linked_list* %18, null
  br i1 %19, label %20, label %21

20:                                               ; preds = %12
  store %struct.linked_list* null, %struct.linked_list** @tail, align 8
  br label %26

21:                                               ; preds = %12
  %22 = load %struct.linked_list*, %struct.linked_list** @head, align 8
  ...
  %25 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %24, i32 0, i32 2
  store %struct.linked_list* null, %struct.linked_list** %25, align 8
  br label %26
...
27:                                               ; preds = %9
  ...
  %29 = bitcast i8* %28 to %struct.linked_list*
  store %struct.linked_list* %29, %struct.linked_list** %3, align 8
  %30 = call noalias i8* @malloc(i64 24) #3
  %31 = bitcast i8* %30 to %struct.linked_list*
  store %struct.linked_list* %31, %struct.linked_list** %4, align 8
  store i32 1, i32* %5, align 4
  %32 = load %struct.linked_list*, %struct.linked_list** @head, align 8
  store %struct.linked_list* %32, %struct.linked_list** %3, align 8
  br label %33
...
37:                                               ; preds = %33
  %38 = load %struct.linked_list*, %struct.linked_list** %3, align 8
  %39 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %38, i32 0, i32 1
  %40 = load %struct.linked_list*, %struct.linked_list** %39, align 8
  %41 = icmp ne %struct.linked_list* %40, null
  br label %42
...
44:                                               ; preds = %42
  %45 = load %struct.linked_list*, %struct.linked_list** %3, align 8
  %46 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %45, i32 0, i32 1
  %47 = load %struct.linked_list*, %struct.linked_list** %46, align 8
  store %struct.linked_list* %47, %struct.linked_list** %3, align 8
...
54:                                               ; preds = %50
  %55 = load %struct.linked_list*, %struct.linked_list** %3, align 8
  %56 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %55, i32 0, i32 2
  %57 = load %struct.linked_list*, %struct.linked_list** %56, align 8
  store %struct.linked_list* %57, %struct.linked_list** %4, align 8
  %58 = load %struct.linked_list*, %struct.linked_list** %3, align 8
  %59 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %58, i32 0, i32 1
  %60 = load %struct.linked_list*, %struct.linked_list** %59, align 8
  %61 = load %struct.linked_list*, %struct.linked_list** %4, align 8
  ...
  %63 = load %struct.linked_list*, %struct.linked_list** %3, align 8
  %64 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %63, i32 0, i32 1
  %65 = load %struct.linked_list*, %struct.linked_list** %64, align 8
  %66 = icmp eq %struct.linked_list* %65, null
  br i1 %66, label %67, label %69

67:                                               ; preds = %54
  %68 = load %struct.linked_list*, %struct.linked_list** %4, align 8
  store %struct.linked_list* %68, %struct.linked_list** @tail, align 8
  br label %75

69:                                               ; preds = %54
  %70 = load %struct.linked_list*, %struct.linked_list** %4, align 8
  %71 = load %struct.linked_list*, %struct.linked_list** %3, align 8
  %72 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %71, i32 0, i32 1
  %73 = load %struct.linked_list*, %struct.linked_list** %72, align 8
  %74 = getelementptr inbounds %struct.linked_list, %struct.linked_list* %73, i32 0, i32 2
  store %struct.linked_list* %70, %struct.linked_list** %74, align 8
  br label %75

75:                                               ; preds = %69, %67
  %76 = load %struct.linked_list*, %struct.linked_list** %3, align 8
  %77 = bitcast %struct.linked_list* %76 to i8*
  call void @free(i8* %77) #3
  br label %81

78:                                               ; preds = %50
  %79 = load i32, i32* %5, align 4
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.9, i64 0, i64 0), i32 %79)
  br label %81
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i1 @isValueAvailable(i32 %0) #0 {
  %2 = alloca i1, align 1
  %3 = alloca i32, align 4
  %4 = alloca %struct.linked_list*, align 8
  store i32 %0, i32* %3, align 4
  %5 = load %struct.linked_list*, %struct.linked_list** @head, align 8
  store %struct.linked_list* %5, %struct.linked_list** %4, align 8
  br label %6

6:                                                ; preds = %20, %1
  %7 = load %struct.linked_list*, %struct.linked_list** %4, align 8
  %8 = icmp ne %struct.linked_list* %7, null
  br i1 %8, label %9, label %21

9:                                                ; preds = %6
  %10 = load %struct.linked_list*, %struct.linked_list** %4, align 8
...
16:                                               ; preds = %9
  ...
  store %struct.linked_list* %19, %struct.linked_list** %4, align 8
  br label %20
...
define dso_local void @printLinkedListForward() #0 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.10, i64 0, i64 0))
...
11:                                               ; preds = %7
  ...
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0), i32 %14)
...
24:                                               ; preds = %19, %10
  %25 = call i32 @puts(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i64 0, i64 0))
  ret void
}
...
define dso_local void @printLinkedListBackward() #0 {
  %1 = alloca %struct.linked_list*, align 8
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.13, i64 0, i64 0))
...
25:                                               ; preds = %20, %10
  %26 = call i32 @puts(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i64 0, i64 0))
  ret void
}
