...
start:
  ...
  store ptr %main, ptr %main.dbg.spill, align 8
    #dbg_declare(ptr %main.dbg.spill, !42, !DIExpression(), !50)
  store i64 %argc, ptr %argc.dbg.spill, align 8
    #dbg_declare(ptr %argc.dbg.spill, !43, !DIExpression(), !51)
  store ptr %argv, ptr %argv.dbg.spill, align 8
    #dbg_declare(ptr %argv.dbg.spill, !44, !DIExpression(), !52)
  store i8 %sigpipe, ptr %sigpipe.dbg.spill, align 1
    #dbg_declare(ptr %sigpipe.dbg.spill, !45, !DIExpression(), !53)
...
; call std::rt::lang_start_internal
  ...
  store i64 %v, ptr %v.dbg.spill, align 8, !dbg !56
    #dbg_declare(ptr %v.dbg.spill, !46, !DIExpression(), !57)
  ret i64 %v, !dbg !58
}
...
start:
  ...
  store ptr %_1, ptr %_1.dbg.spill, align 8
    ...
    #dbg_declare(ptr %self, !67, !DIExpression(), !86)
...
; call <() as std::process::Termination>::report
  ...
  store ptr %self, ptr %self.dbg.spill, align 8, !dbg !90
    #dbg_declare(ptr %self.dbg.spill, !91, !DIExpression(), !99)
...
start:
  ...
  %result.dbg.spill = alloca [0 x i8], align 1
    #dbg_declare(ptr %result.dbg.spill, !110, !DIExpression(), !114)
  store ptr %f, ptr %f.dbg.spill, align 8
    #dbg_declare(ptr %f.dbg.spill, !109, !DIExpression(), !115)
    #dbg_declare(ptr %dummy.dbg.spill, !116, !DIExpression(), !124)
...
start:
  ...
  store ptr %_1, ptr %_1.dbg.spill, align 8
    #dbg_declare(ptr %_1.dbg.spill, !143, !DIExpression(), !148)
    #dbg_declare(ptr %_2, !144, !DIExpression(), !148)
...
start:
  ...
  %_2 = alloca [0 x i8], align 1
  store ptr %_1, ptr %_1.dbg.spill, align 8
    #dbg_declare(ptr %_1.dbg.spill, !151, !DIExpression(), !155)
    #dbg_declare(ptr %_2, !152, !DIExpression(), !155)
...
start:
  ...
  store ptr %0, ptr %_1, align 8
    #dbg_declare(ptr %_1, !160, !DIExpression(), !162)
    #dbg_declare(ptr %_2, !161, !DIExpression(), !162)
...
start:
  ...
  store ptr %this, ptr %this.dbg.spill, align 8
    #dbg_declare(ptr %this.dbg.spill, !172, !DIExpression(), !175)
    #dbg_declare(ptr %this.dbg.spill, !176, !DIExpression(), !185)
    #dbg_declare(ptr %this.dbg.spill, !188, !DIExpression(), !198)
    #dbg_declare(ptr %this.dbg.spill, !201, !DIExpression(), !209)
    #dbg_declare(ptr %this.dbg.spill, !211, !DIExpression(), !218)
  store i64 %count, ptr %count.dbg.spill, align 8
    #dbg_declare(ptr %count.dbg.spill, !173, !DIExpression(), !175)
    #dbg_declare(ptr %count.dbg.spill, !183, !DIExpression(), !220)
    #dbg_declare(ptr %count.dbg.spill, !192, !DIExpression(), !198)
    #dbg_declare(ptr %count.dbg.spill, !221, !DIExpression(), !248)
    #dbg_declare(ptr %count.dbg.spill, !251, !DIExpression(), !265)
  store i64 %size, ptr %size.dbg.spill, align 8
    #dbg_declare(ptr %size.dbg.spill, !174, !DIExpression(), !175)
    #dbg_declare(ptr %size.dbg.spill, !184, !DIExpression(), !267)
    #dbg_declare(ptr %size.dbg.spill, !193, !DIExpression(), !198)
  store i64 %size, ptr %rhs.dbg.spill, align 8, !dbg !268
    #dbg_declare(ptr %rhs.dbg.spill, !244, !DIExpression(), !269)
    #dbg_declare(ptr %rhs.dbg.spill, !260, !DIExpression(), !270)
  ...
  store i64 %_10.0, ptr %a.dbg.spill, align 8, !dbg !272
    #dbg_declare(ptr %a.dbg.spill, !261, !DIExpression(), !273)
  %1 = zext i1 %_10.1 to i8, !dbg !274
  store i8 %1, ptr %b.dbg.spill, align 1, !dbg !274
    #dbg_declare(ptr %b.dbg.spill, !247, !DIExpression(), !275)
    #dbg_declare(ptr %b.dbg.spill, !264, !DIExpression(), !276)
    #dbg_declare(ptr %b.dbg.spill, !277, !DIExpression(), !282)
  store i64 %_10.0, ptr %byte_offset.dbg.spill, align 8, !dbg !284
    #dbg_declare(ptr %byte_offset.dbg.spill, !194, !DIExpression(), !285)
    #dbg_declare(ptr %byte_offset.dbg.spill, !245, !DIExpression(), !286)
    #dbg_declare(ptr %byte_offset.dbg.spill, !287, !DIExpression(), !302)
...
bb5:                                              ; preds = %start
  ...
  store i64 %self, ptr %self.dbg.spill, align 8, !dbg !305
    #dbg_declare(ptr %self.dbg.spill, !298, !DIExpression(), !306)
    #dbg_declare(ptr %self.dbg.spill, !307, !DIExpression(), !316)
  store i64 %_10.0, ptr %rhs.dbg.spill1, align 8, !dbg !318
    #dbg_declare(ptr %rhs.dbg.spill1, !312, !DIExpression(), !319)
  ...
  store i64 %_20.0, ptr %a.dbg.spill2, align 8, !dbg !321
    #dbg_declare(ptr %a.dbg.spill2, !313, !DIExpression(), !322)
  %3 = zext i1 %_20.1 to i8, !dbg !323
  store i8 %3, ptr %overflowed.dbg.spill, align 1, !dbg !323
    #dbg_declare(ptr %overflowed.dbg.spill, !301, !DIExpression(), !324)
    #dbg_declare(ptr %overflowed.dbg.spill, !315, !DIExpression(), !325)
  store i64 %_20.0, ptr %res.dbg.spill, align 8, !dbg !326
    #dbg_declare(ptr %res.dbg.spill, !299, !DIExpression(), !327)
  ...
  store i8 %4, ptr %overflow.dbg.spill, align 1, !dbg !329
    #dbg_declare(ptr %overflow.dbg.spill, !196, !DIExpression(), !330)
...
start:
  %_1.dbg.spill = alloca [8 x i8], align 8
  store ptr %_1, ptr %_1.dbg.spill, align 8
    #dbg_declare(ptr %_1.dbg.spill, !339, !DIExpression(), !342)
  ret void, !dbg !342
}
...
start:
  ...
  %_1.dbg.spill = alloca [0 x i8], align 1
    #dbg_declare(ptr %_1.dbg.spill, !349, !DIExpression(), !350)
    #dbg_declare(ptr %self.dbg.spill, !348, !DIExpression(), !350)
  ret i8 0, !dbg !351
}
...
start:
  ...
  store ptr %arr, ptr %arr.dbg.spill, align 8
    #dbg_declare(ptr %arr.dbg.spill, !359, !DIExpression(), !365)
  store i32 %size, ptr %size.dbg.spill, align 4
    #dbg_declare(ptr %size.dbg.spill, !360, !DIExpression(), !366)
    #dbg_declare(ptr %total, !361, !DIExpression(), !367)
    #dbg_declare(ptr %i, !363, !DIExpression(), !368)
...
bb2:                                              ; preds = %bb1
  ...
  store ptr %arr, ptr %self.dbg.spill.i, align 8
    #dbg_declare(ptr %self.dbg.spill.i, !376, !DIExpression(), !384)
  store i64 %_9, ptr %count.dbg.spill.i, align 8
    #dbg_declare(ptr %count.dbg.spill.i, !381, !DIExpression(), !386)
...
start:
  ...
  %arr = alloca [20 x i8], align 4
    #dbg_declare(ptr %arr, !399, !DIExpression(), !408)
