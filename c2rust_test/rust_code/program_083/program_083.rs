...
#[no_mangle]
pub unsafe extern "C" fn findMaxUsingLevelOrder(
    mut root: *mut BinaryTreeNode,
) -> libc::c_int {
...
unsafe fn main_0() -> libc::c_int {
    ...
    (*(*root).right).right = createNewNode(19 as libc::c_int);
    ...
    printf(
        b"Maximum in tree is %d\0" as *const u8 as *const libc::c_char,
