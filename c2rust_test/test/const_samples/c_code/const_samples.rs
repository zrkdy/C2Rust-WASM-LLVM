...
#[no_mangle]
pub static mut SIMPLE_INT: libc::c_int = 42 as libc::c_int;
#[no_mangle]
pub static mut SIMPLE_FLOAT: libc::c_float = 3.14f64 as libc::c_float;
#[no_mangle]
pub static mut SIMPLE_CHAR: libc::c_char = 'A' as i32 as libc::c_char;
#[no_mangle]
pub static mut STRING_LITERAL: *const libc::c_char = b"Hello, world!\0" as *const u8
    as *const libc::c_char;
#[no_mangle]
pub static mut ANOTHER_CONST: libc::c_int = 100 as libc::c_int;
#[no_mangle]
...
pub static mut POINTER_TO_MUTABLE: *const libc::c_int = unsafe {
    &mutable_var as *const libc::c_int as *mut libc::c_int
};
#[no_mangle]
...
#[no_mangle]
pub static mut SIMPLE_STRUCT: Point = {
    let mut init = Point {
        x: 10 as libc::c_int,
        y: 20 as libc::c_int,
    };
...
#[no_mangle]
pub static mut STRUCT_WITH_CONST_PTR: Person = {
    let mut init = Person {
        id: 1 as libc::c_int,
...
#[no_mangle]
pub static mut STRUCT_WITH_MUTABLE_PTR: Record = unsafe {
    {
        let mut init = Record {
            id: 2 as libc::c_int,
            data: &mutable_var as *const libc::c_int as *mut libc::c_int,
        };
        init
    }
};
#[no_mangle]
pub static mut INT_ARRAY: [libc::c_int; 3] = [
    1 as libc::c_int,
    2 as libc::c_int,
    3 as libc::c_int,
];
...
pub static mut MUTABLE_PTR_ARRAY: [*const libc::c_int; 2] = unsafe {
    [
        &mutable_var as *const libc::c_int as *mut libc::c_int as *const libc::c_int,
        &mutable_var as *const libc::c_int as *mut libc::c_int as *const libc::c_int,
    ]
};
#[no_mangle]
...
#[no_mangle]
pub static mut COMPLEX_STRUCT: Complex = unsafe {
    {
